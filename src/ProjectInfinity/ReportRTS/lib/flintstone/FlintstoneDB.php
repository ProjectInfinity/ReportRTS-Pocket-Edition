...
namespace ProjectInfinity\ReportRTS\lib\flintstone;

use ProjectInfinity\ReportRTS\lib\flintstone\depend\FormatterInterface;
use ProjectInfinity\ReportRTS\lib\flintstone\depend\SerializeFormatter;
...
class FlintstoneDB
{
     ...
     * - object     $depend          the depend class used to encode/decode data
    ...
    public function __construct($database, array $options = array())
    {
        ...
        $this->setFormatter($options['depend']);
    ...
    /**
     * Set the depend used to encode/decode data
     *
     * @param object $formatter the depend class
     *
